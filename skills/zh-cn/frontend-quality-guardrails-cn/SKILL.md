...
description: 构建、修改或审查前端界面时使用的质量守门技能，重点检查超长文本、溢出、换行、截断、对齐、间距、响应式、组件状态、可访问性、国际化、视觉细节、项目代码审查和浏览器截图验证。适用于 HTML、CSS、JavaScript、TypeScript、React、Vue、Svelte、Next.js、Tailwind、shadcn/ui、Ant Design、后台系统、表单、表格、卡片、导航和移动端布局。
---
